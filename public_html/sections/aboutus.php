    ...
    <section id="aboutus" class="about">
      ...
      <div class="container" data-aos="fade-up">
        <h2 style="text-align: center;font-size: 34px;">About Us</h2>
        <div class="row gx-0">
          <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
            <img src="assets/img/gif/vision.gif" class="img-fluid" alt="">
          </div>

          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              <h2><br><br>Our Vision</h2>
              <p>Our vision is to establish the <b>world's largest network of interconnected commercial vehicles</b>, empowering the comprehensive fleet management ecosystem of OFeX.
              </p>              
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
            <img src="assets/img/gif/we_believe.gif" class="img-fluid" alt="">
          </div>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gx-0">
          <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
            <img src="assets/img/gif/challanges.gif" class="img-fluid" alt="">
          </div>
